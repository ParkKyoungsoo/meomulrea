    ...
    <v-container>
      ...
      <v-row>
        <v-tabs v-model="tab" fixed-tabs color="orange accent-4">
          <v-tab class="menu" @click="showContent(1)"><img src="../assets/image/menu.png" alt="menu" width="35"></v-tab> 
          <v-tab class="review" @click="showContent(2)"><img src="../assets/image/review.png" alt="review" width="35"></v-tab> 
          <v-tab class="party" @click="showContent(3)"><img src="../assets/image/high-five.png" alt="party" width="35"></v-tab>
        </v-tabs>
      </v-row>
      <v-row>
        <v-col>
  ...
  methods: {
    changeStartTime(time) {
      ...
      if (time[5] == 'H') {
        // P0DT0H0M~
        if (time[7] == 'M') {
          this.startTime = '0' + time.substring(4,5) + ':'+ time.substring(6,7) + '0'
        }
        // P0DT0H00M~
        else {
      ...
      // P0DT00H~
        ...
        // P0DT00H0M~
        if (time[8] == 'M') {
          this.startTime = time.substring(4,6) + ':' + time.substring(7,8) + '0'
        }
        // P0DT00H00M~
        else {
    ...
    changeEndTime(time) {
      if (time[5] == 'H') {
        if (time[7] == 'M') {
          this.endTime = '0' + time.substring(4,5) + ':'+ time.substring(6,7) + '0'
        }
        else {
        ...
        if (time[8] == 'M') {
          this.endTime = time.substring(4,6) + ':' + time.substring(7,8) + '0'
        }
        else {
